CREATE OR REPLACE PACKAGE BODY B_PACKAGE IS
...
END PROC_ADD_CUSTOMER;
 PROCEDURE PRO_ADD_CUST_CONTACT
...
BEGIN
 ...
 WHEN OTHERS THEN
  NULL;
END PRO_ADD_CUST_CONTACT;
PROCEDURE PRO_DEL_CUST(P_BANK_CUST_ID BANK_CUST.CUST_ID%TYPE) IS
BEGIN
 DELETE BANK_CUST WHERE BANK_CUST.CUST_ID=P_BANK_CUST_ID;
 --COMMIT;
END PRO_DEL_CUST;

PROCEDURE PRO_DEL_CUST(P_CUST_FIRST_NAME BANK_CUST.CUST_FIRST_NAME%TYPE) IS
BEGIN
 DELETE BANK_CUST WHERE CUST_FIRST_NAME=INITCAP(P_CUST_FIRST_NAME);
 --COMMIT;
END PRO_DEL_CUST;

PROCEDURE PRO_ADD_SB_ACCOUNT (
...
EXCEPTION
  ...
  WHEN OTHERS THEN
  NULL;
END PRO_ADD_SB_ACCOUNT;
PROCEDURE PRO_SB_DEPOSIT (P_TRANS_ACC_NO BANK_TRANSACTION.TRANS_ACC_NO%TYPE,
...
PROCEDURE PRO_SB_WITHDRAW (P_TRANS_ACC_NO BANK_TRANSACTION.TRANS_ACC_NO%TYPE,
                          P_TRANS_DESC BANK_TRANSACTION.TRANS_DESC%TYPE,
                          P_TRANS_AMT BANK_TRANSACTION.TRANS_AMT%TYPE) IS
V_COUNT NUMBER;
